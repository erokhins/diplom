...
\usepackage{amssymb, amsmath, amsthm, amsfonts, amscd, geometry, hyperref}
\usepackage{indentfirst} % Indent the first paragraph as well

%\newenvironment{Proof} % имя окружения
%{\par{\bf Доказательство.}} % команды для \begin
%{\hfill$\scriptstyle\square$} % для команды \end

\pagestyle{plain} % нумерация страниц

\unitlength=1mm % хрень для картинок
...
\thispagestyle{empty}
\newgeometry{top=30mm,bottom=5mm,left=20mm,right=15mm,nohead}
\begin{center}
	{ Правительство Российской Федерации \par
Федеральное государственное бюджетное образовательное учреждение высшего профессионального образования \par
«Санкт-Петербургский государственный университет»\par\vskip0.6em
		
	Кафедра теории вероятностей и математической статистики \par
	\par}
\end{center}

\vspace{36mm}
\begin{center}
	{\large Ерохин Станислав Евгеньевич}
\end{center}

\vspace{5mm}
\begin{center}
	\begin{spacing}{1.8}{\bf \LARGE Рост двудольных графов с реберным приоритетом }\end{spacing}
	\bf{\large Дипломная работа}
\end{center}

\vskip0em
	\begin{flushright}
		{\small Допущена к защите.
		
		Зав. кафедрой:
		
		доктор физ.-мат. наук, профессор Никитин Я.\,Ю.
%		д.\,ф.-м.\,н., профессор Никитин Я.\,Ю.
		
		\vspace{12mm}
		Научный руководитель:
		
		кандидат физ.-мат. наук, доцент Якубович Ю.\,В.
		
		\vspace{12mm}
		Рецензент:
		
		кандидат физ.-мат. наук, доцент Валландер С.\,С.}
	\end{flushright}
	\vspace{25mm}
	\begin{center}
		Санкт-Петербург
	...
	\begin{center}
		{ SAINT-PETERSBURG STATE UNIVERSITY\par
			\vskip0.6em
			Chair of Probability Theory and Mathematical Statistics\par
			\par}
	\end{center}
	
	\vspace{36mm}
	\begin{center}
		{\large Stanislav Erokhin}
	\end{center}
	\vspace{0mm}
	\begin{center}
		\begin{spacing}{1.8}{\bf \LARGE Bipartite graph growth with edge priority}\end{spacing}
		\bf{\large Graduation thesis}
	\end{center}
	
	\vskip0em
	\begin{flushright}
		{\small Admitted for defence.
			
			Head of the chair:\\
			Professor  Yakov Nikitin 
			...
			Associate Professor Sergej Vallander }
	\end{flushright}
	\vspace{20mm}
	\begin{center}
		Saint-Petersburg
...
\begin{thebibliography}{XXXX}
	{% Открывающая фигурная скобка небходима
		...
		\bibitem[Il]{Ilyn}{ В.П.~Ильин}, {\em Некоторые интегральные неравенства и их применения в теории дифференцируемых функций многих переменных} // Математический сборник, 54 (1961), no. 3, 331--380.
		
		\bibitem[Ko]{Kolonitskii}{ С.Б.~Колоницкий}, {\em Множественность решений задачи Дирихле для уравнения с $ p $-лапласианом в трехмерном сферическом слое} // Алгебра и анализ, 22 (2010), no. 3, 206--221.
