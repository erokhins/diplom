...
\filltitle{en}{
    ...
    reviewerPosition   = {Associate Arofessor},
...
%%%%%%------------------Введение
\section*{Введение}
В 2002 году был создан протокол обмена данными: BitTorrent, который играет важную роль в обмене данными 
в современном мире. При этом, он остаётся не до 
